...
class LeaveApply extends PureComponent {
    constructor(props) {
        ...
        else if (this.props.editLeave.editEmp.EmployeeId !== '') {
            this.state = {
                LeaveId: this.props.editLeave.editEmp.LeaveId,
                EmployeeId: this.props.editLeave.editEmp.EmployeeId,
                leaveFromDate: new Date(this.props.editLeave.editEmp.LeaveDate),
                leaveType: this.props.editLeave.editEmp.LeaveType,
                leaveCount: this.props.editLeave.editEmp.LeaveCount,
                remarks: this.props.editLeave.editEmp.Remarks == null ? '' : this.props.editLeave.editEmp.Remarks,
                IsApproved: this.props.editLeave.editEmp.IsApproved,
                refresh: false,
                type: '',
                edittype: 'edit'
            }
    ...
    handlesubmit = async (event) => {
        ...
        await this.props.getUpdateEmpId(this.props.editLeave.editEmp.EmployeeId);
