...
class Employee extends React.Component {
    constructor() {
        ...
        this.state = {
            ...
            BankDetail: '',
            showEmployeeForm: '',
            data: [{ value: 'M', text: 'Male' }, { value: 'F', text: 'Female' }]
        }
        ...
        return (
            <>
                <div className="col-md-12" style={{ marginTop: "9px", marginBottom: "10px" }} >
                    <div className="pull-left col-md-3" style={{ color: "#2e508f" }} ><h3>Employees</h3>
                        <br />
                        <a href='javascript:void(0)' onClick={this.createNewEmployee}  ><h6>Create New Employee</h6></a>
                        <EmployeesList employeeData={this.props.leaveInfo.getEmployeeData} editEmployeeDetails={this.editEmployeeDetails} />
                    </div>
                    <form onSubmit={this.handleSubmit}>
                        {this.state.showEmployeeForm == 'show' && <div id="container" className="row ei-page-title">
                            <div className="col-md-12">
                                ...
                                <div className="form-horizontal">
                                    ...
                                    <br />
                                    <div className="row">
                                        <label className="col-md-2 col-lg-2 col-sm-2">Dasignation</label>
                                        <div className="col-md-10 col-lg-10 col-sm-10">
                                    ...
                                    <div className="row">
                                        ...
                                        <div className="col-md-10 col-lg-10 col-sm-10">
                                            <Dropdown data={this.state.data} name='Gender' value={this.state.Gender} onChange={this.handleChange} />
                                        </div>
                                    </div>
                                    <br />
                                    <div className="row">
