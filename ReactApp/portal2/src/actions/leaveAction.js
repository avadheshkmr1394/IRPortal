...
import { GET_LEAVE_DATA, EMPLOYEE_LEAVE_COUNT, GET_EMPLOYEE_DATA, EDIT_LEAVE_DATA, GET_EMPLOYEE_ID,GET_LEAVE_REPORT } from './actionTypes';
...
export const getLeaveReport = (params) => {
    ...
    const url = 'Employee/GetLeaveReport'
    const request = postAxios(url, { params: params })
    return {
